...
/**
 * This is the model class for table "onlineapp.app_application_without_ref".
 *
 ...
 */
class AppApplicationWithoutRef extends \yii\db\ActiveRecord
{
    ...
    {
        return 'onlineapp.app_application_without_ref';
    }
