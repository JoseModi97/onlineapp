...
/**
 * ApplicationSearch represents the model behind the search form of `app\models\AppApplication`.
 */
class ApplicationSearch extends AppApplication
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['application_id', 'applicant_id', 'intake_code', 'application_fee_id', 'payment_status', 'sync_status', 'app_publish', 'letter_downloaded'], 'integer'],
    ...
    public function search($params, $formName = null)
    {
        ...
        $query->andFilterWhere([
            ...
            'app_publish' => $this->app_publish,
            'letter_downloaded' => $this->letter_downloaded,
        ]);
