...
/**
 * ApplicationDeletedSearch represents the model behind the search form of `app\models\AppApplicationDeleted`.
 */
class ApplicationDeletedSearch extends AppApplicationDeleted
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = AppApplicationDeleted::find();
