...
/**
 * ApplicationWithoutRefSearch represents the model behind the search form of `app\models\AppApplicationWithoutRef`.
 */
class ApplicationWithoutRefSearch extends AppApplicationWithoutRef
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = AppApplicationWithoutRef::find();
