...
/**
 * This is the model class for table "onlineapp.app_application_deleted".
 *
 ...
 */
class AppApplicationDeleted extends \yii\db\ActiveRecord
{
    ...
    {
        return 'onlineapp.app_application_deleted';
    }
